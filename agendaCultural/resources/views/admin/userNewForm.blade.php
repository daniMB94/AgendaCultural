                    ...
                    <div class="-mx-3 md:flex mb-6" id="empresas" style="display: none">
                        <div class="md:w-full px-3">
                            ...
                            <div class="relative">
                                ...
                                <select class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" name="empresa" id="empresaSeleccionada" autofocus>

        ...
        <section class="container px-4 mx-auto">
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex items-center mt-4 gap-x-3">
                    ...
                    <button id="guardarUsuario" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                    ...
                    <div class="-mx-3 md:flex mb-6" id="empresas" style="display: none">
                        <div class="md:w-full px-3">
                            ...
                            <div class="relative">
                                ...
                                <select class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" name="empresa" required autofocus>
                                    @foreach($empresas as $empresa)
                                    @if($empresa->nombre != 'admin' && $empresa->nombre != 'asistente')

                                    <option value="{{$empresa->id}}" {{$empresa->id == $user->empresa_id ? 'selected' : ''}}>{{$empresa->nombre}}
                                    </option>
                                    @endif
                                    @endforeach
                                </select>

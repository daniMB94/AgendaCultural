...
<body class="text-gray-800 font-inter">
    ...
    <main class="w-full md:w-[calc(100%-224px)] md:ml-56 bg-gray-200 min-h-screen transition-all main">
        ...
        <section class="container px-4 mx-auto">
                ...
                <div class="flex items-center mt-4 gap-x-3">
                    ...
                    <button
                        ...
                        <a class="flex items-center justify-center"
                            href=" {{ route('usuarios.delete', ['id' => $user]) }}"><svg
            ...
            <!-- component -->
            <form id="formularioActualizarUsuario" method="post" action="{{route('admin.userUpdate')}}">
                @csrf
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
                    <div class="-mx-3 md:flex mb-6">
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                id="grid-first-name" type="text" name="nombre" value="{{$user->nombre}}" required
                                autofocus placeholder="{{$user->nombre}}">
                    ...
                    <div class="-mx-3 md:flex mb-6">
                        ...
                        <div class="md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4"
                                id="grid-last-name" type="email" name="email" value="{{$user->email}}" required
                                autofocus placeholder="{{$user->email}}">
                        </div>
                    ...
                    <div class="-mx-3 md:flex mb-2">
                        <div class="md:w-1/3 px-3">
                            ...
                            <input
                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4"
                                id="grid-zip" type="text" name="direccion" value="{{$user->direccion}}" required
                                autofocus placeholder="{{$user->direccion}}">
                        </div>
                        <div class="md:w-1/3 px-3 mb-6 md:mb-0">
                            <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2"
                                for="grid-city">

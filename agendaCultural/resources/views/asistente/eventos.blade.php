<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-subnav-link :href="route('asistente.eventos.semana', ['filtro' => now()->weekOfYear])" :active="request()->routeIs('asistente.eventos')">
                    {{ __('Eventos de la semana') }}
                </x-subnav-link>
            </div>
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-subnav-link :href="route('asistente.eventos.mes', ['filtro' => now()->month])" :active="request()->routeIs('asistente.eventos')">
                    {{ __('Eventos del mes') }}
                </x-subnav-link>
            </div>
        </div>

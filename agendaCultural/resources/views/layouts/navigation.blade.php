            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('asistente.eventos') }}">
                        <img src="{{asset('images/escudo-taberno.png')}}" class="w-12 h-auto" alt="Inicio">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('asistente.eventos')" :active="Str::of(request()->route()->getName())->is(['asistente.eventos', 'asistente.eventos.semana', 'asistente.eventos.mes'])">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('asistente.experiencias')" :active="request()->routeIs('asistente.experiencias')">
                        {{ __('Experiencias') }}
                    </x-nav-link>
                </div>
            </div>
